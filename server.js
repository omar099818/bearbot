...
.addField("**:globe_with_meridians:[BearBot 🐻]**","** **")
      ...
      .addField("**b*support :arrows_counterclockwise:**","**سيرفر البوت**")
         .addField("**b*channelinfo :speech_balloon:**","**معلومات عن الروم**")
...
.setThumbnail(message.author.avatarURL)    
      .addField("**Music Command 🎼**","** **")
         .addField("**b*play ▶️**","**شغل**")
         .addField("**b*stop ⏹️**","**وقف**")
         .addField("**b*skip ⏭️**","**تخطي**")
         .addField("**b*join 📥**","**ادخل**")
         .addField("**b*leave 📤**","**اخرج**")
         .addField("**b*start ⏯️**","**استمرار**")
         .addField("**b*vol ⏫**","**صوت**")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
...
client.on('message', message => {
    ...
    .setColor(100000)
    .setFooter(`f*help to see all client commands `, ' http://www.logoground.com/uploads/201792132017-02-144450652Polar%20Bear%20Logo.jpg')
    message.channel.sendEmbed(embed)
...
const discord_token = "Mzk4MTg1OTMzODg0NzUxODcy.DVcKxw.WbaHE3n-qt-X_pRCS79oxdBcuaA";
